...
The **deadlines** for the corresponding labs are on the **Wednesdays** that immediately followed by the lab sessions. 
...
- If any questions require working with files, they can be found in either `/opt/assets` or `/opt/cs1102-notes/lab_tasks`

:::{.callout-important}
- The command prompt from the CS1102 course VM must be visible in the solution screenshot for every question
- If there is **no prompt**, you will rceieve **zero marks** in that lab
:::
...
<a href="https://support.google.com/docs/answer/6367684" target="_blank">Check here</a> to know about how to create a outlines in the document
